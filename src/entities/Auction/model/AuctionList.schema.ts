...
export const AuctionListRequestSchema = z
  .object({
    ...
    load_city: z.string().trim().optional(),
    load_date_from: z.string().trim().optional(),
    load_date_to: z.string().trim().optional(),
    unload_city: z.string().trim().optional(),
    unload_date_from: z.string().trim().optional(),
    unload_date_to: z.string().trim().optional(),
